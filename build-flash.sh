...
# e.g. SOURCE_DIR=${HOME}/Android/angler-legacy
SOURCE_DIR=

# ANYKERNEL_DIR: Directory that holds your AnyKernel source
# e.g. ANYKERNEL_DIR=${HOME}/Android/AnyKernel2-legacy
ANYKERNEL_DIR=
...
ANYKERNEL_BRANCH=angler-flash-m-release
